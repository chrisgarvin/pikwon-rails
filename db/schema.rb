...
ActiveRecord::Schema.define(version: 20150610154950) do
  ...
  add_index "picks", ["option_id"], name: "index_picks_on_option_id", using: :btree
  add_index "picks", ["post_id"], name: "index_picks_on_post_id", using: :btree
